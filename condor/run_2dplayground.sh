...
echo python exercises/bs_select_2d_playground.py $*
python exercises/bs_select_2d_playground.py $*

xrdcp -f rootfiles/*.root root://cmseos.fnal.gov//store/user/musafdar/CMSDAS2023/rootfiles/
